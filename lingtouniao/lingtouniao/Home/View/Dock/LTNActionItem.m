...
{
    CGFloat imageY = DimensionBaseIphone6(14);
    CGFloat imageWidth = DimensionBaseIphone6(40.0);
    CGFloat imageHeight = DimensionBaseIphone6(40.0);
...
- (CGRect)titleRectForContentRect:(CGRect)contentRect
{
    ...
    CGFloat titleY = contentRect.size.height - DimensionBaseIphone6(8) - titleHeight;
