...
@property (nonatomic,strong)SubmitOrderModel *submitOrderModel;
//鸟币支持
...
//从前页传过来的金券
@property (nonatomic,strong)NSMutableArray *coupounsBefore;

//回调产品详情页
//@property (nonatomic,copy)ESHandlerBlock addCoupounBlock;
