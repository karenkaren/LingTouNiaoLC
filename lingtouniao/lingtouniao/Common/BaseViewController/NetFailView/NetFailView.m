...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _remindeLabel.font = [CustomerizedFont systemFontOfSize:16];
        ...
        _subRemindeLabel.font = [CustomerizedFont systemFontOfSize:13];
...
- (void)layoutSubviews{
    ...
    if (_customView) {
        ...
        _customView.center = self.myCenter;
        
    }else{
        
        UIImage *im = _failIm.image;
        _failIm.frame = CGRectMake(0, 0,DimensionBaseIphone6(im.size.width*750/1080),DimensionBaseIphone6(im.size.height*750/1080));
        _failIm.center =CGPointMake(self.bounds.size.width/2, self.bounds.size.height/2 -_failIm.frame.size.height/2.-DimensionBaseIphone6(30));
        //[_remindeLabel sizeToFit];
        _remindeLabel.center = CGPointMake(self.bounds.size.width/2, self.bounds.size.height/2);
        //[_subRemindeLabel sizeToFit];
        _subRemindeLabel.center =CGPointMake(_remindeLabel.center.x, _remindeLabel.center.y+DimensionBaseIphone6(30));
